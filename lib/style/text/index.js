 ...
 * @return {Function}
 */
export function lowerRight(text, font, fillStyle, alpha, distance) {
  return atPos(
    (target, metrics) => target.width - (metrics.width + 10),
    target => (target.height - distance) || (target.height - 10),
    text,
    font,
    fillStyle,
    alpha
 ...
 * @return {Function}
 */
export function lowerLeft(text, font, fillStyle, alpha, distance) {
  return atPos(
    () => 10,
    target => (target.height - distance) || (target.height - 10),
    text,
 ...
 * @return {Function}
 */
export function upperRight(text, font, fillStyle, alpha, distance) {
  return atPos(
    (target, metrics) => target.width - (metrics.width + 10),
    () => distance || 20,
    text,
 ...
 * @return {Function}
 */
export function upperLeft(text, font, fillStyle, alpha, distance) {
  return atPos(
    () => 10,
    () => distance || 20,
    text,
 ...
 * @return {Function}
 */
export function center(text, font, fillStyle, alpha) {
  return atPos(
