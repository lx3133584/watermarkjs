 ...
 * @return {Function}
 */
export function lowerRight(image, width, height, alpha) {
  return atPos(
    image, width, height,
 ...
 * @return {Function}
 */
export function upperRight(image, width, height, alpha) {
  return atPos(
    image, width, height,
    (target, mark) => target.width - (mark.width + 10),
    (target, mark) => 10,
 ...
 * @return {Function}
 */
export function lowerLeft(image, width, height, alpha) {
  return atPos(
    image, width, height,
    (target, mark) => 10,
    (target, mark) => target.height - (mark.height + 10),
 ...
 * @return {Function}
 */
export function upperLeft(image, width, height, alpha) {
  return atPos(
    image, width, height,
    (target, mark) => 10,
    (target, mark) => 10,
